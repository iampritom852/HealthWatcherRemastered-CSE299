        ...
        Log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(emailStr.matches(emailPattern))){
                    check1=1;
                    mainToast = Toast.makeText(getApplicationContext(), "Invalid email address", Toast.LENGTH_SHORT);
                    mainToast.show();
                }
                ...
                if (passStr.equals(passPat)) {
                    check1=1;
                    mainToast = Toast.makeText(getApplicationContext(), "Password must contain lower case & upper case letters, numbers, special characters.", Toast.LENGTH_SHORT);
                    mainToast.show();
                }

                if (passStr.length() < 5 || passStr.length() > 15) {
                    check1=1;
                    mainToast = Toast.makeText(getApplicationContext(), "Password length must be between 5-15 characters", Toast.LENGTH_SHORT);
                    mainToast.show();
                }
